document.addEventListener("DOMContentLoaded", () => {
    ...
    skillSelect.addEventListener("change", () => {
        handleSkillSelectChange(skillSelect, "skill-container");
    });
    ...
    function handleSkillSelectChange(selectElement, containerId) {
        const skillContainer = document.getElementById(containerId);
        if (skillContainer.children.length > 0) {
            alert("직군은 하나만 선택할 수 있습니다.");
            selectElement.selectedIndex = 0; // 선택 취소
            return;
        }
